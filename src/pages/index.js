    ...
    return (
        <>
            ...
            <div className="md:pt-44 pt-36 px-4 md:px-0 bg-gray-100">
                ...
                <div className="flex flex-col md:flex-row justify-center md:mx-20 px-4  md:mt-32 mt-10 md:space-x-20 md:space-y-0 space-y-4 md:py-0 py-6 bg-white shadow-lg rounded-lg md:rounded-md items-center md:h-56 font-extralight transition duration-300 transform hover:shadow-blue-500 hover:shadow-md ">
